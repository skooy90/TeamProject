...
public class DashboardServlet extends HttpServlet {
  @Override protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	  ...
	  Map<String,Integer> p = WorkDAO.getInstance().findOverallProgress();
	    int total = p.getOrDefault("total", 0);
	    int done  = p.getOrDefault("done",  0);
    ...
    req.setAttribute("workTotal", total);
    req.setAttribute("workDone",  done);
    req.setAttribute("workRemain", remain);
    req.setAttribute("workRate",  rate);

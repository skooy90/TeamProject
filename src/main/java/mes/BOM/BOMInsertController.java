...
@WebServlet("/bom/insert")
public class BOMInsertController extends HttpServlet {
    private static final long serialVersionUID = 1L;
    
    private BOMDAO bomDAO;
    
    public BOMInsertController() {
        super();
        bomDAO = new BOMDAO();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (standardCode == null || standardCode.trim().isEmpty() ||
                ...
                response.sendRedirect(request.getContextPath() + "/bom/form");
                return;
            }
            ...
            // DB에 등록
            int result = bomDAO.insertBOM(bom);
